class Solution:
    def mySqrt(self, x: int) -> int:
        ...
        while l <= r:
            ...
            # This could be the result since we want the larget m^2 which is less than or equal to x
            else:
                l = m + 1
                result = m

        # If/once loop terminates, our result is set to the greatest mid value 
        # that is less than x when result^2
        return result
